...
export default function Home({ markers, menu_list, ciudad }) {
  ...
  return (
    <>
      <Head>
        <title> Compro Oro Granada | Vender Oro Granada</title>
        <meta
          name="description"
          content="Vende tus piezas de oro y plata en nuestro compro oro en Granada. Tasación a la vista y precios siempre actualizados."
        />
